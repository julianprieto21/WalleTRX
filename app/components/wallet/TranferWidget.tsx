...
export default function TransferWidget() {
  return (
    ...
    <button
      title="transfer"
      disabled
      className="cursor-not-allowed flex rounded-3xl justify-center items-center bg-palette-300 hover:bg-neutral-600 text-transfer hover:text-neutral-400 transition ease-in-out delay-10 p-2"
    >
      <DataTransferBoth className="rotate-90 size-16 xl:size-12 2xl:size-14" />
    </button>
  );
