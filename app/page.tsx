...
export default async function HomePage() {
  ...
  if (!user) return;
  return (
    <main className="page pt-8 2xl:pt-12 pb-6 px-4 2xl:px-10 gap-8">
      <div className=" mt-4">
      ...
      <div className="mt-0 2xl:mt-0 h-32 2xl:h-auto p-2 2xl:absolute 2xl:right-10 2xl:top-10 overflow-x-scroll overflow-y-hidden no-scrollbar">
        <Accounts />
      </div>
      <div className="w-full h-full 2xl:h-auto flex flex-col items-center 2xl:flex-row gap-0 2xl:gap-8 mt-0">
        <Suspense
          fallback={
